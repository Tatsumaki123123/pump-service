function rl_formatter(parsedInstruction, txn) {
  let output = {};
  const instructions = parsedInstruction.instructions.find(
    (x) => x.name === "initialize"
  );
  ...
  if (txn.version === 0) {
    output = {
      ...
      meta: {
        ...txn.meta,
        asc: parsedInstruction.inner_ixs,
      },
      transaction: {
        ...txn.transaction,
        message: {
