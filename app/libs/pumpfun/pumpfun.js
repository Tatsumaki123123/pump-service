...
exports.PumpFunSDK = exports.DEFAULT_DECIMALS = exports.METADATA_SEED = exports.CREATOR_VAULT_SEED = exports.BONDING_CURVE_SEED = exports.MINT_AUTHORITY_SEED = exports.GLOBAL_ACCOUNT_SEED = void 0;
...
exports.CREATOR_VAULT_SEED = "creator-vault";
...
class PumpFunSDK {
    ...
    async createAndBuy(creator, mint, createTokenMetadata, buyAmountSol, slippageBasisPoints = 500n, priorityFees, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY) {
        ...
        let createResults = await (0, util_1.returnTx)(newTx, priorityFees);
    ...
    async buy(buyer, mint, buyAmountSol, slippageBasisPoints = 500n, priorityFees, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY) {
        ...
        let buyResults = await (0, util_1.returnTx)(buyTx, priorityFees);
        return buyResults;
    }
    async sell(seller, mint, sellTokenAmount, slippageBasisPoints = 500n, priorityFees, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY) {
        ...
        let sellResults = await (0, util_1.returnTx)(sellTx, priorityFees);
        return sellResults;
    }
    ...
    async getCreateInstructions(creator, name, symbol, uri, mint) {
        ...
        const [metadataPDA] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(exports.METADATA_SEED), mplTokenMetadata.toBuffer(), mint.publicKey.toBuffer()], mplTokenMetadata);
    ...
    async getBuyInstructionsBySolAmount(buyer, mint, buyAmountSol, slippageBasisPoints = 500n, commitment = util_1.DEFAULT_COMMITMENT, bondingCurveAccount) {
    ...
    //buy
    async getBuyInstructions(buyer, mint, feeRecipient, amount, solAmount, bondingCurveCreator, commitment = util_1.DEFAULT_COMMITMENT) {
    ...
    async getBuyInstructions2(buyer, mint, feeRecipient, amount, solAmount, commitment = util_1.DEFAULT_COMMITMENT) {
        const associatedBondingCurve = (0, spl_token_1.getAssociatedTokenAddressSync)(mint, this.getBondingCurvePDA(mint), true);
    ...
    getCreatorVaultPDA(creator) {
        return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(exports.CREATOR_VAULT_SEED), creator.toBuffer()], this.program.programId)[0];
    }
