...
import { CreateTokenMetadata, PriorityFee, PumpFunEventHandlers, PumpFunEventType } from "./types";
...
export declare const CREATOR_VAULT_SEED = "creator-vault";
...
export declare class PumpFunSDK {
    ...
    createAndBuy(creator: PublicKey, mint: Keypair, createTokenMetadata: CreateTokenMetadata, buyAmountSol: bigint, slippageBasisPoints?: bigint, priorityFees?: PriorityFee, commitment?: Commitment, finality?: Finality): Promise<Transaction>;
    buy(buyer: PublicKey, mint: PublicKey, buyAmountSol: bigint, slippageBasisPoints?: bigint, priorityFees?: PriorityFee, commitment?: Commitment, finality?: Finality): Promise<Transaction>;
    sell(seller: PublicKey, mint: PublicKey, sellTokenAmount: bigint, slippageBasisPoints?: bigint, priorityFees?: PriorityFee, commitment?: Commitment, finality?: Finality): Promise<Transaction>;
