...
export declare const calculateWithSlippage: (amount: bigint, basisPoints: bigint) => bigint;
export declare function returnTx(tx: Transaction, priorityFees?: PriorityFee): Promise<Transaction>;
