const account1 = [
  {
    account: "ASFgdYSwUBs5z7LipLarF4A9TBRxQeJd5AFXp1f7wH32",
    signer: false,
    writable: false,
    label: "pool",
  },
  {
    account: "CL3NczTBZh4mGfvLFVEb4LMrvg92QrpNXHwDuZ54Jq8g",
    signer: true,
    writable: true,
    label: "user",
  },
  ...
  {
    account: "AhtTjcSc5Y2mK89uAzMDj19oZpmJLWzFqxwknJo6pump",
    signer: false,
    writable: false,
    label: "base_mint",
  },
  ...
  {
    account: "N98ATLjkvupUrjGddiPRmeKsyH97zk9kdZ7fcAo9yVh",
    signer: false,
    writable: true,
    label: "user_base_token_account",
  },
  {
    account: "4kJcjRt8nyBus1VhtAjRjePsw47byinFRRHDXfZS2tsy",
    signer: false,
    writable: true,
    label: "user_quote_token_account",
  },
  {
    account: "5yUkEt5PMfHLqz7dsJd5ePUCnMUMawSKamQEuYN7hfcv",
    signer: false,
    writable: true,
    label: "pool_base_token_account",
  },
  {
    account: "9ARHB5P4zGs7WJEykG52yxQGxmyP6C6VbEZtu7QtGdZd",
    signer: false,
    writable: true,
    label: "pool_quote_token_account",
  },
  {
    account: "7hTckgnGnLQR6sdH7YkqFTAA7VwTfYFaZ6EhEsU3saCX",
    signer: false,
    writable: false,
  ...
  {
    account: "6Su1m6ZkMJDwVhkCpxiP5hw7pBHsr3doybZwxhhFkUzV",
    signer: false,
    writable: true,
    label: "coin_creator_vault_ata",
  },
  {
    account: "D2FFFSs4ZgrJynyRJoaUx4uWwZAS6kExuJdBMxebKNMZ",
    signer: false,
    writable: false,
...
const accounts2 = [
  {
    account: "62WKbtUmTdKx2GnC877pL9vxsEEfJfxnEQ8CorfqQT6W",
    signer: false,
    writable: false,
    label: "pool",
  },
  ...
  {
    account: "H1Cep68ExwUCsmmGxwCSxpbdNQPZqaeFtbfYtKg3pump",
    signer: false,
    writable: false,
    label: "base_mint",
  },
  ...
  {
    account: "F4EXWakqUBpxNuTJzHX5Xk8fCsHbTQCwszNJCaSFN93Z",
    signer: false,
    writable: true,
    label: "user_base_token_account",
  },
  ...
  {
    account: "D8YnJ7NzNoykiTcTs6XkfifoKsp6L6GRpnR64ymDBDyN",
    signer: false,
    writable: true,
    label: "pool_base_token_account",
  },
  {
    account: "CED1SWv6HhgJEDDLb4eLJNhXVnf6URdYpBphLGWyCVCQ",
    signer: false,
    writable: true,
    label: "pool_quote_token_account",
  },
  {
    account: "62qc2CNXwrYqQScmEdiZFFAnJR262PxWEuNQtxfafNgV",
    signer: false,
    writable: false,
    label: "protocol_fee_recipient",
  },
  {
    account: "94qWNrtmfn42h3ZjUZwWvK1MEo9uVmmrBPd2hpNjYDjb",
    signer: false,
    writable: true,
    label: "protocol_fee_recipient_token_account",
  },
  ...
  {
    account: "BnSrQMBUowJdktqgTPTFknfEMMDpSVY6yqNaKRX5Dt9i",
    signer: false,
    writable: true,
    label: "coin_creator_vault_ata",
  },
  {
    account: "5QwX5hf8A67S4oRnhUsbdWGLTdggdsdvpWfW5CanYXdM",
    signer: false,
    writable: false,
    label: "coin_creator_vault_authority",
  },
...
for (const key in obj1) {
  if (Object.prototype.hasOwnProperty.call(obj1, key)) {
    const item = obj1[key];
    if (obj2[key].account === obj1[key].account) {
      sameObj.push(item);
    }
  }
}
